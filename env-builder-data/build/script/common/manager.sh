...
$TC_LD_LIBRARY_PATH"
    ...
    export PKG_CONFIG_PATH="$ENVDEPS_PACKET_DIR/lib/pkgconfig:$ENVDEPS_PACKET_DIR/lib64/pkgconfig:$ENVDEPS_PACKET_DIR/share/pkgconfig:$ENVDEPS_NATIVE_PACKET_DIR/lib/pkgconfig:$TC_PKG_CONFIG_PATH"
