...
PK_DIRNAME="SuperLU_4.1"
PK_ARCHIVE="superlu_4.1.tar.gz"
...
pkinstall() {
	...
	mkdir -p "$INSTALL_PACKET_DIR/include/superlu-4.1"
	cp --remove-destination $BUILD_PACKET_DIR/$PK_DIRNAME/SRC/*.h "$INSTALL_PACKET_DIR/include/superlu-4.1" || return 1
}
