...
export TOOLCHAIN_FORTRAN=/usr/bin/$TOOLCHAIN_HOST-gfortran
export TOOLCHAIN_LD=/usr/bin/$TOOLCHAIN_HOST-ld
export TOOLCHAIN_AR=/usr/bin/$TOOLCHAIN_HOST-ar
export TOOLCHAIN_RANLIB=/usr/bin/$TOOLCHAIN_HOST-ranlib
...
export TOOLCHAIN_PKG_CONFIG_LIBDIR="/usr/$TOOLCHAIN_HOST/sys-root/mingw/lib"
export TOOLCHAIN_XDG_DATA_DIRS="$INITIAL_XDG_DATA_DIRS"
export TOOLCHAIN_ACLOCAL_PATH="$INITIAL_ACLOCAL_PATH"
export TOOLCHAIN_CMAKE_INCLUDE_PATH="/usr/$TOOLCHAIN_HOST/sys-root/mingw/include:$INITIAL_CMAKE_INCLUDE_PATH"
export TOOLCHAIN_CMAKE_LIBRARY_PATH="/usr/$TOOLCHAIN_HOST/sys-root/mingw/lib:$INITIAL_CMAKE_LIBRARY_PATH"
